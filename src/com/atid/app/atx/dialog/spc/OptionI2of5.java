...
public class OptionI2of5 extends BaseDialog implements OnClickListener{
	private static final String TAG = OptionI2of5.class.getSimpleName();
	private static final int INFO = ATLog.L2;
	
	private TextView txtI2of5CheckDigit;
	private TextView txtLengthMin;
	private TextView txtLengthMax;
	
	private EnumListDialog dlgI2of5CheckDigit;
	...
	public OptionI2of5() {
		...
		mI2of5CheckDigit = CheckDigit.NoCheckDigit;
		mLengthMin = 4;
		mLengthMax = 80;
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_barcode_option_spc_2d_i2of5, null);
		
		txtI2of5CheckDigit = (TextView) root.findViewById(R.id.i2of5_check_digit);
		txtI2of5CheckDigit.setOnClickListener(this);
		...
		dlgI2of5CheckDigit = new EnumListDialog(txtI2of5CheckDigit, CheckDigit.values());
		dlgI2of5CheckDigit.setValue(mI2of5CheckDigit);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				mI2of5CheckDigit = (CheckDigit) dlgI2of5CheckDigit.getValue();
				
				mLengthMin = dlgLengthMin.getValue();
				mLengthMax = dlgLengthMax.getValue();
				
				if(changedListener != null){
					changedListener.onValueChanged(OptionI2of5.this);
				}
			}
		});
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(cancelListener != null){
					cancelListener.onCanceled(OptionI2of5.this);
				}
	...
	public void onClick(View v) {
		switch(v.getId()){
		case R.id.i2of5_check_digit:
			dlgI2of5CheckDigit.showDialog(mContext, R.string.i2of5_check_digit);
			break;
		case R.id.min:
