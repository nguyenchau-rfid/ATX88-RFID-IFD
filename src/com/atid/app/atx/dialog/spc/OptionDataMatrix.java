...
public class OptionDataMatrix extends BaseDialog implements OnClickListener{
	private static final String TAG = OptionDataMatrix.class.getSimpleName();
	private static final int INFO = ATLog.L2;
	
	private TextView txtLengthMin;
	private TextView txtLengthMax;
//	private CheckBox chkDataMatrixAppend;
	private TextView txtDataMatrixCodePage;
	
	private NumberDialog dlgLengthMin;
	private NumberDialog dlgLengthMax;
	private EnumListDialog dlgDataMatrixCodePage;
...
//	private boolean mIsDataMatrixAppend;
	...
	public OptionDataMatrix() {
		super();
		
		mLengthMin = 1;
		mLengthMax = 3116;
		//mIsDataMatrixAppend = true;
		mDataMatrixCodePage = CodePages.ISOIEC_2022;
...
//	}
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_barcode_option_spc_2d_data_matrix, null);
...
//		chkDataMatrixAppend = (CheckBox) root.findViewById(R.id.data_matrix_append);
//		chkDataMatrixAppend.setOnCheckedChangeListener(this);
		txtDataMatrixCodePage = (TextView) root.findViewById(R.id.data_matrix_code_page);
		txtDataMatrixCodePage.setOnClickListener(this);
		...
		dlgDataMatrixCodePage = new EnumListDialog(txtDataMatrixCodePage, CodePages.values());
		dlgDataMatrixCodePage.setValue(mDataMatrixCodePage);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				mDataMatrixCodePage = (CodePages) dlgDataMatrixCodePage.getValue();
				
//				mIsDataMatrixAppend = chkDataMatrixAppend.isChecked();

				if(changedListener != null){
					changedListener.onValueChanged(OptionDataMatrix.this);
				}
			}
		});
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(cancelListener != null){
					cancelListener.onCanceled(OptionDataMatrix.this);
				}
		...
		dialog.setOnShowListener(new DialogInterface.OnShowListener() {
			...
			public void onShow(DialogInterface dialog) {
				...
				dlgDataMatrixCodePage.display();
				
//				chkDataMatrixAppend.setChecked(mIsDataMatrixAppend);
	...
	public void onClick(View v) {
		...
		case R.id.max:
			...
			break;
		case R.id.data_matrix_code_page:
			dlgDataMatrixCodePage.showDialog(mContext, R.string.data_matrix_code_page);
			break;
		}
