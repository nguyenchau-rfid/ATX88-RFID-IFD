...
public class OptionStraight2of5IATA extends BaseDialog implements OnClickListener{
	private static final String TAG = OptionStraight2of5IATA.class.getSimpleName();
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, 
				R.layout.dialog_barcode_option_spc_2d_straight2of5_iata, null);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(changedListener != null){
					changedListener.onValueChanged(OptionStraight2of5IATA.this);
				}
			}
		});
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(cancelListener != null){
					cancelListener.onCanceled(OptionStraight2of5IATA.this);
				}
