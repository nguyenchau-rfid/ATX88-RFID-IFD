...
public class OptionHanXinCode extends BaseDialog implements OnClickListener{
	private static final String TAG = OptionHanXinCode.class.getSimpleName();
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, 
				R.layout.dialog_barcode_option_spc_2d_han_xin_code, null);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(changedListener != null){
					changedListener.onValueChanged(OptionHanXinCode.this);
				}
			}
		});
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(cancelListener != null){
					cancelListener.onCanceled(OptionHanXinCode.this);
				}
