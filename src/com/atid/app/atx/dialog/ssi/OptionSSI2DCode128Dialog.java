...
public class OptionSSI2DCode128Dialog extends BaseDialog implements OnClickListener, OnCheckedChangeListener{
	private static final String TAG = OptionSSI2DCode128Dialog.class.getSimpleName();
	...
	private CheckBox chkCode128ReducedQuietZone;
	private CheckBox chkIgnoreCode128Fnc4;
	...
	public OptionSSI2DCode128Dialog(){
		super();
		...
		mIsCode128ReducedQuietZone = false;
		mIsIgnoreCode128Fnc4 = false;
	...
	public boolean getCode128ReducedQuietZone(){
		return mIsCode128ReducedQuietZone;
	}
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_barcode_option_ssi_2d_code128, null);
		...
		chkCode128ReducedQuietZone = (CheckBox) root.findViewById(R.id.code128_reduced_quiet_zone);
		chkCode128ReducedQuietZone.setOnCheckedChangeListener(this);
		chkIgnoreCode128Fnc4 = (CheckBox) root.findViewById(R.id.ignore_code128_fnc4);
		chkIgnoreCode128Fnc4.setOnCheckedChangeListener(this);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				mIsCode128ReducedQuietZone = chkCode128ReducedQuietZone.isChecked();
				mIsIgnoreCode128Fnc4 = chkIgnoreCode128Fnc4.isChecked();
				
				if(changedListener != null)
					changedListener.onValueChanged(OptionSSI2DCode128Dialog.this);
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(cancelListener != null)
					cancelListener.onCanceled(OptionSSI2DCode128Dialog.this);
		...
		dialog.setOnShowListener(new DialogInterface.OnShowListener() {
			...
			public void onShow(DialogInterface dialog) {
				...
				chkCode128ReducedQuietZone.setChecked(mIsCode128ReducedQuietZone);
				chkIgnoreCode128Fnc4.setChecked(mIsIgnoreCode128Fnc4);
	...
	private void displayLength(){
		...
		if(mLength.getLength1() ==0 && mLength.getLength2() == 0){	//	AnyLength
			linearLenght1.setVisibility(View.GONE);
			linearLenght2.setVisibility(View.GONE);
		} else if( mLength.getLength1() !=0 && mLength.getLength2() == 0 ) {	// OneLength
			linearLenght1.setVisibility(View.VISIBLE);
			linearLenght2.setVisibility(View.GONE);

		} else if( mLength.getLength1() > mLength.getLength2() ) {		//TwoLength
			linearLenght1.setVisibility(View.VISIBLE);
