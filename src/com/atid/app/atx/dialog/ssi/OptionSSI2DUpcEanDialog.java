...
public class OptionSSI2DUpcEanDialog extends BaseDialog implements OnClickListener, OnCheckedChangeListener{
	private static final String TAG = OptionSSI2DUpcEanDialog.class.getSimpleName();
	...
	private TextView txtUpcEanjanSupplementalAimIdFormat;
	private CheckBox chkUpcReducedQuietZone;
	...
	private EnumListDialog dlgUpcEanjanSupplementalAimIdFormat;
	...
	public OptionSSI2DUpcEanDialog(){
		super();
		...
		mUpcEanjanSupplementalAimIdFormat = UpcEanJanSupplementalAIMIDFormat.Combined;
		mIsUpcReducedQuietZone = false;
	...
	public UpcEanJanSupplementalAIMIDFormat getUpcEanJanSupplementalAIMIDFormat(){
		return mUpcEanjanSupplementalAimIdFormat;
	}
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_barcode_option_ssi_2d_upc_ean, null);
		...
		txtUpcEanjanSupplementalAimIdFormat = (TextView) root.findViewById(R.id.upc_ean_jan_supplemental_aim_id_format); 
		txtUpcEanjanSupplementalAimIdFormat.setOnClickListener(this);
		chkUpcReducedQuietZone = (CheckBox) root.findViewById(R.id.upc_reduced_quiet_zone);           
		chkUpcReducedQuietZone.setOnCheckedChangeListener(this);
		...
		dlgUpcEanjanSupplementalAimIdFormat = new EnumListDialog(txtUpcEanjanSupplementalAimIdFormat, UpcEanJanSupplementalAIMIDFormat.values());
		dlgUpcEanjanSupplementalAimIdFormat.setValue(mUpcEanjanSupplementalAimIdFormat);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				mUpcEanjanSupplementalAimIdFormat = (UpcEanJanSupplementalAIMIDFormat) dlgUpcEanjanSupplementalAimIdFormat.getValue();
				...
				mIsUpcReducedQuietZone = chkUpcReducedQuietZone.isChecked();
				...
				if(changedListener != null)
					changedListener.onValueChanged(OptionSSI2DUpcEanDialog.this);
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(cancelListener != null)
					cancelListener.onCanceled(OptionSSI2DUpcEanDialog.this); 
		...
		dialog.setOnShowListener(new DialogInterface.OnShowListener() {
			...
			public void onShow(DialogInterface dialog) {
				...
				dlgUpcEanjanSupplementalAimIdFormat.display();
				dlgUpcAPreamble.display();
				dlgUpcEPreamble.display();
				dlgUpcE1Preamble.display();
				dlgCouponReport.display();
				
				chkUpcReducedQuietZone.setChecked(mIsUpcReducedQuietZone);
	...
	public void onClick(View v) {
		...
		case R.id.upc_ean_jan_supplemental_redundancy:
			...
			break;
		case R.id.upc_ean_jan_supplemental_aim_id_format:
			dlgUpcEanjanSupplementalAimIdFormat.showDialog(mContext, R.string.upc_ean_jan_supplemental_aim_id_format);
			break;
