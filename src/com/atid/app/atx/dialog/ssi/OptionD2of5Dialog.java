...
public class OptionD2of5Dialog extends BaseDialog implements OnClickListener{
	private static final String TAG = OptionD2of5Dialog.class.getSimpleName();
	...
	public OptionD2of5Dialog(){
		super();
		
		mLength = new CodeLength(0, 55);
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_barcode_option_ssi_2d_d2of5, null);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(changedListener != null)
					changedListener.onValueChanged(OptionD2of5Dialog.this);
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(cancelListener != null)
					cancelListener.onCanceled(OptionD2of5Dialog.this); 
