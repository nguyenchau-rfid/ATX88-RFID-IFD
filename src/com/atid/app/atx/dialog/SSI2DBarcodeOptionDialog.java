...
import com.atid.app.atx.dialog.ssi.Option1DQuietZoneDialog;
import com.atid.app.atx.dialog.ssi.Option2DSymbolDialog;
import com.atid.app.atx.dialog.ssi.OptionCodabarDialog;
import com.atid.app.atx.dialog.ssi.OptionCode11Dialog;
import com.atid.app.atx.dialog.ssi.OptionSSI2DCode128Dialog;
import com.atid.app.atx.dialog.ssi.OptionSSI2DCode39Dialog;
import com.atid.app.atx.dialog.ssi.OptionCode93Dialog;
import com.atid.app.atx.dialog.ssi.OptionCompositeDialog;
import com.atid.app.atx.dialog.ssi.OptionD2of5Dialog;
import com.atid.app.atx.dialog.ssi.OptionGs1DatabarDialog;
import com.atid.app.atx.dialog.ssi.OptionSSI2DI2of5Dialog;
import com.atid.app.atx.dialog.ssi.OptionMatrix2of5Dialog;
import com.atid.app.atx.dialog.ssi.OptionMsiDialog;
import com.atid.app.atx.dialog.ssi.OptionPostalCodesDialog;
import com.atid.app.atx.dialog.ssi.OptionSSI2DUpcEanDialog;
...
public class SSI2DBarcodeOptionDialog implements OnClickListener {
	private static final String TAG = SSI2DBarcodeOptionDialog.class.getSimpleName();
	...
	private LinearLayout linearOptionPostalCodes;
	private LinearLayout linearOptionGs1Databar;
	private LinearLayout linearOptionComposite;
	private LinearLayout linearOption2DSymbol;
	private LinearLayout linearOption1DQuietZone;
	private LinearLayout linearOptionRedundancyLevel;
	private LinearLayout linearOptionSecurityLevel;
	private LinearLayout linearOptionInverse1D;
	
	private TextView txtRedundancyLevel;
	private TextView txtSecurityLevel;
	private TextView txtInverse1D;
	
	private OptionSSI2DUpcEanDialog dlgUpcEan;
	private OptionSSI2DCode128Dialog dlgCode128;
	private OptionSSI2DCode39Dialog dlgCode39;
	private OptionCode93Dialog dlgCode93;
	private OptionCode11Dialog dlgCode11;
	private OptionSSI2DI2of5Dialog dlgI2of5;
	...
	private OptionPostalCodesDialog dlgPostalCodes;
	private OptionGs1DatabarDialog dlgGs1Databar;
	private OptionCompositeDialog dlgComposite;
	private Option2DSymbolDialog dlg2DSymbol;
	private Option1DQuietZoneDialog dlg1DQuietZone;
	
	private EnumListDialog dlgRedundancyLevel;
	private EnumListDialog dlgSecurityLevel;
	private EnumListDialog dlgInverse1D;
	...
	private UpcEanJanSupplementalAIMIDFormat mUpcEanjanSupplementalAimIdFormat;
	private boolean mIsUpcReducedQuietZone;
	...
	private boolean mIsCode128ReducedQuietZone;
	private boolean mIsIgnoreCode128Fnc4;
	...
	private boolean mIsCode39BufferingScanStore;
	private boolean mIsCode39ReducedQuietZone;
	...
	// ETC
	private RedundancyLevel mRedundancyLevel;
	private SecurityLevel mSecurityLevel;
	private Inverse1D mInverse1D;
	
	private Context mContext;
	
	public SSI2DBarcodeOptionDialog() {
		dlgUpcEan = new OptionSSI2DUpcEanDialog();
		dlgCode128 = new OptionSSI2DCode128Dialog();
		dlgCode39 = new OptionSSI2DCode39Dialog();
		dlgCode93 = new OptionCode93Dialog();
		dlgCode11 = new OptionCode11Dialog();
		dlgI2of5 = new OptionSSI2DI2of5Dialog();
		...
		dlgPostalCodes = new OptionPostalCodesDialog();
		dlgGs1Databar = new OptionGs1DatabarDialog();
		dlgComposite = new OptionCompositeDialog();
		dlg2DSymbol = new Option2DSymbolDialog();
		dlg1DQuietZone = new Option1DQuietZoneDialog();
		...
		mRedundancyLevel = RedundancyLevel.Level1;
		mSecurityLevel = SecurityLevel.Level1;
		mInverse1D = Inverse1D.Regular;
	...
	public UpcEanJanSupplementalAIMIDFormat getUpcEanJanSupplementalAIMIDFormat(){
		return dlgUpcEan.getUpcEanJanSupplementalAIMIDFormat();
	}
	
	public void setUpcEanJanSupplementalAIMIDFormat(UpcEanJanSupplementalAIMIDFormat value){
		dlgUpcEan.setUpcEanJanSupplementalAIMIDFormat(value);
		mUpcEanjanSupplementalAimIdFormat = value;
	}
	
	public boolean getUpcReducedQuietZone(){
		return dlgUpcEan.getUpcReducedQuietZone();
	}
	
	public void setUpcReducedQuietZone(boolean value){
		dlgUpcEan.setUpcReducedQuietZone(value);
		mIsUpcReducedQuietZone = value;
	}
	...
	public boolean getCode128ReducedQuietZone(){
		return dlgCode128.getCode128ReducedQuietZone();
	}
	
	public void setCode128ReducedQuietZone(boolean value){
		dlgCode128.setCode128ReducedQuietZone(value);
		mIsCode128ReducedQuietZone = value;
	}
	
	public boolean getIgnoreCode128Fnc4(){
		return dlgCode128.getIgnoreCode128Fnc4();
	}
	
	public void setIgnoreCode128Fnc4(boolean value){
		dlgCode128.setIgnoreCode128Fnc4(value);
		mIsIgnoreCode128Fnc4 = value;
	}
	...
	public boolean getCode39BufferingScanStore(){
		return dlgCode39.getCode39BufferingScanStore();
	}
	
	public void setCode39BufferingScanStore(boolean value){
		dlgCode39.setCode39BufferingScanStore(value);
		mIsCode39BufferingScanStore = value;
	}

	public boolean getCode39ReducedQuietZone(){
		return dlgCode39.getCode39ReducedQuietZone();
	}
	
	public void setCode39ReducedQuietZone(boolean value){
		dlgCode39.setCode39ReducedQuietZone(value);
		mIsCode39ReducedQuietZone = value;
	}
	...
	public boolean getI2of5ReducedQuietZone(){
		return dlgI2of5.getI2of5ReducedQuietZone();
	}
	
	public void setI2of5ReducedQuietZone(boolean value){
		dlgI2of5.setI2of5ReducedQuietZone(value);
	...
	// ETC
	// ---------------------------------
	public Inverse1D getInverse1D(){
		return mInverse1D;
	}
	
	public void setInverse1D(Inverse1D value){
		mInverse1D = value;
	}
	
	public RedundancyLevel getRedundancyLevel(){
		return mRedundancyLevel;
	}
	
	public void setRedundancyLevel(RedundancyLevel value){
		mRedundancyLevel = value;
	}
	...
	public void restoreParameterValue() {
		...
		dlgUpcEan.setUpcEanJanSupplementalAIMIDFormat(mUpcEanjanSupplementalAimIdFormat);
		dlgUpcEan.setUpcReducedQuietZone(mIsUpcReducedQuietZone);
		...
		dlgCode128.setCode128ReducedQuietZone(mIsCode128ReducedQuietZone);
		dlgCode128.setIgnoreCode128Fnc4(mIsIgnoreCode128Fnc4);
		...
		dlgCode39.setCode39BufferingScanStore(mIsCode39BufferingScanStore);
		dlgCode39.setCode39ReducedQuietZone(mIsCode39ReducedQuietZone);
		...
		dlgI2of5.setI2of5ReducedQuietZone(mIsI2of5ReducedQuietZone);
		...
		// PostalCodes
		dlgPostalCodes.setTransmitUsPostalCheckDigit(mIsTransmitUsPostalCheckDigit);
		dlgPostalCodes.setTransmitUkPostalCheckDigit(mIsTransmitUkPostalCheckDigit);
		dlgPostalCodes.setAustraliaPostFormat(mAustraliaPostFormat);
		...
		// Composite
		dlgComposite.setUpcCompositeMode(mUpcCompositeMode);
		dlgComposite.setCompositeBeepMode(mCompositeBeepMode);
		dlgComposite.setGs1128Emulation(mIsGs1128EmulationMode);
		
		// 2D Symbol
		dlg2DSymbol.setCode128Emulation(mIsCode128Emulation);
		dlg2DSymbol.setDataMatrixInverse(mDataMatrixInverse);
		dlg2DSymbol.setDecodeMirrorImages(mDecodeMirrorImages);
		dlg2DSymbol.setQRInverse(mQRInverse);
		dlg2DSymbol.setAztecInverse(mAztecInverse);
		dlg2DSymbol.setHanXinInverse(mHanXinInverse);
		
		// 1D Quiet Zone
		dlg1DQuietZone.set1DQuietZoneLevel(m1DQuietZoneLevel);
		dlg1DQuietZone.setIntercharacterGapSize(mIntercharacterGapSize);
	...
	public void showDialog(Context context, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_barcode_option_ssi_2d, null);
		...
		linearOptionPostalCodes = (LinearLayout) root.findViewById(R.id.linear_barcode_option_postal_codes);
		linearOptionPostalCodes.setOnClickListener(this);
		...
		linearOptionComposite = (LinearLayout) root.findViewById(R.id.linear_barcode_option_composite);
		linearOptionComposite.setOnClickListener(this);
		linearOption2DSymbol = (LinearLayout) root.findViewById(R.id.linear_barcode_option_2d_symbol);
		linearOption2DSymbol.setOnClickListener(this);
		linearOption1DQuietZone = (LinearLayout) root.findViewById(R.id.linear_barcode_option_1d_quiet_zone);
		linearOption1DQuietZone.setOnClickListener(this);
		linearOptionRedundancyLevel = (LinearLayout) root.findViewById(R.id.linear_barcode_option_redundancy_level);
		linearOptionRedundancyLevel.setOnClickListener(this);
		...
		linearOptionInverse1D = (LinearLayout) root.findViewById(R.id.linear_barcode_option_inverse_1d);
		linearOptionInverse1D.setOnClickListener(this);
		
		txtRedundancyLevel = (TextView) root.findViewById(R.id.redundancy_level);
		txtSecurityLevel = (TextView) root.findViewById(R.id.security_level);
		txtInverse1D = (TextView) root.findViewById(R.id.inverse_1d);
	
		dlgRedundancyLevel = new EnumListDialog(txtRedundancyLevel, RedundancyLevel.values());
		dlgRedundancyLevel.setValue(mRedundancyLevel);
		dlgSecurityLevel = new EnumListDialog(txtSecurityLevel, SecurityLevel.values());
		dlgSecurityLevel.setValue(mSecurityLevel);
		dlgInverse1D = new EnumListDialog(txtInverse1D, Inverse1D.values());
		dlgInverse1D.setValue(mInverse1D);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				mRedundancyLevel = (RedundancyLevel) dlgRedundancyLevel.getValue();
				mSecurityLevel = (SecurityLevel) dlgSecurityLevel.getValue();
				mInverse1D = (Inverse1D) dlgInverse1D.getValue();
				
				if(changedListener != null){
					changedListener.onValueChanged(SSI2DBarcodeOptionDialog.this);
				}
		...
		dialog.setOnShowListener(new DialogInterface.OnShowListener() {
			...
			public void onShow(DialogInterface dialog) {
				...
				dlgRedundancyLevel.display();
				dlgSecurityLevel.display();
				dlgInverse1D.display();
	...
	public void onClick(View v) {
		...
		case R.id.linear_barcode_option_upc_ean:
			...
			break;
			case R.id.linear_barcode_option_postal_codes:
				dlgPostalCodes.showDialog(mContext, R.string.postal_codes);
			break;
			case R.id.linear_barcode_option_gs1_databar:
				dlgGs1Databar.showDialog(mContext, R.string.gs1_databar);
			break;
			case R.id.linear_barcode_option_composite:
				dlgComposite.showDialog(mContext, R.string.composite);
			break;
			case R.id.linear_barcode_option_2d_symbol:
				dlg2DSymbol.showDialog(mContext, R.string.symbol_2d);
			break;
			case R.id.linear_barcode_option_1d_quiet_zone:
				dlg1DQuietZone.showDialog(mContext, R.string.quiet_zone_1d);
			break;
			case R.id.linear_barcode_option_redundancy_level:
				dlgRedundancyLevel.showDialog(mContext, R.string.redundancy_level);
			break;
			case R.id.linear_barcode_option_security_level:
				dlgSecurityLevel.showDialog(mContext, R.string.security_level);
			break;
			case R.id.linear_barcode_option_inverse_1d:
				dlgInverse1D.showDialog(mContext, R.string.inverse_1d);
			break;
	...
	public interface IValueChangedListener {
		void onValueChanged(SSI2DBarcodeOptionDialog dialog);
	}
