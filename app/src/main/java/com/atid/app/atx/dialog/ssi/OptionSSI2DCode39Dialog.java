...
public class OptionSSI2DCode39Dialog extends BaseDialog implements OnClickListener, OnCheckedChangeListener{
	private static final String TAG = OptionSSI2DCode39Dialog.class.getSimpleName();
	...
	private CheckBox chkCode39BufferingScanStore;
	private CheckBox chkCode39ReducedQuietZone;
	...
	public OptionSSI2DCode39Dialog(){
		super();
		...
		mIsCode39BufferingScanStore = false;
		mIsCode39ReducedQuietZone = false;
	...
	public boolean getCode39BufferingScanStore(){
		return mIsCode39BufferingScanStore;
	}
	...
	public boolean getCode39ReducedQuietZone(){
		return mIsCode39ReducedQuietZone;
	}
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_barcode_option_ssi_2d_code39, null);
		...
		chkCode39BufferingScanStore = (CheckBox) root.findViewById(R.id.code39_buffering_scan_store);      
		chkCode39BufferingScanStore.setOnCheckedChangeListener(this);
		chkCode39ReducedQuietZone = (CheckBox) root.findViewById(R.id.code39_reduced_quiet_zone);        
		chkCode39ReducedQuietZone.setOnCheckedChangeListener(this);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				mIsCode39BufferingScanStore = chkCode39BufferingScanStore.isChecked();
				mIsCode39ReducedQuietZone = chkCode39ReducedQuietZone.isChecked();
				
				if(changedListener != null)
					changedListener.onValueChanged(OptionSSI2DCode39Dialog.this);
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if(cancelListener != null)
					cancelListener.onCanceled(OptionSSI2DCode39Dialog.this);
		...
		dialog.setOnShowListener(new DialogInterface.OnShowListener() {
			...
			public void onShow(DialogInterface dialog) {
				...
				chkCode39BufferingScanStore.setChecked(mIsCode39BufferingScanStore);
				chkCode39ReducedQuietZone.setChecked(mIsCode39ReducedQuietZone);
