...
public class OptionGs1128 extends BaseDialog implements OnClickListener{
	private static final String TAG = OptionGs1128.class.getSimpleName();
	...
	public void showDialog(Context context, String title, final IValueChangedListener changedListener,
		...
		LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_barcode_option_spc_2d_gs1_128, null);
		...
		builder.setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(changedListener != null){
					changedListener.onValueChanged(OptionGs1128.this);
				}
			}
		});
		...
		builder.setNegativeButton(R.string.action_cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(cancelListener != null){
					cancelListener.onCanceled(OptionGs1128.this);
				}
